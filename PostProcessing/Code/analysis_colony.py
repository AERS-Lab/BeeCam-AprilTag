...
from parameters_list_crop_by_datetime import *
...
# Generate initial and final datetime of processing
start_datetime = datetime(crop_datetime[0], crop_datetime[1], crop_datetime[2])
stop_datetime = date_time[-1]

    
csv_report_2(colony, p, start_datetime, stop_datetime)
