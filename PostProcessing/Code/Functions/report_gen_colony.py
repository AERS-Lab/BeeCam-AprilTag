...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 25 18:25:25 2024
...
def report_gen_colony(colony, week, min_ID, max_ID, detections_by_ID, events_by_ID, trips_by_ID, all_trips_sec, p):
    # ===========================================================================
    # Calculate statistics
    # =============================================================================
    print('=========================================================')
    print('Statistics for "' + colony + '" at 2xWeek "' + str(week) + '" ' )
    print('=========================================================')
    print('')
    ...
    p.total_avg_trip_length_stdev.append(str(timedelta(seconds=round(avg_trip_length_stdev))).replace(',', ' '))
    p.total_avg_trip_length_time.append(str(avg_trip_length_time).replace(',', ' '))
    ...
    p.total_avg_event_length_time.append(str(avg_event_length_time).replace(',', ' '))
    p.total_avg_event_length_time_std.append(str(avg_event_length_time_std).replace(',', ' '))
