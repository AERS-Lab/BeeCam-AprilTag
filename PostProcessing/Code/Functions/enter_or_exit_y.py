...
def enter_or_exit_y(y_start,y_end):
    ...
    if y_start - y_end > 75: # set the 'enter' threshold
        return 'enter'
    elif y_start - y_end < -75: # set the 'exit' threshold (number must stay negative)
        return 'exit'
    elif y_start > 250 and y_end > 250: # set the 'failed_to_enter' threshold
        return 'failed_to_enter'
    elif y_start < 150 and y_end > 150: # set the 'failed_to_exit' threshold
